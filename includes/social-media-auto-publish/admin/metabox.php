...
function xyz_smap_add_custom_box() {
	...
	if ( ( get_option( 'xyz_smap_af' )==0 && get_option( 'xyz_smap_fb_token' )!="" && get_option( 'xyz_smap_post_permission' )==1 ) || ( get_option( 'xyz_smap_twconsumer_id' )!="" && get_option( 'xyz_smap_twconsumer_secret' )!="" && get_option( 'xyz_smap_tw_id' )!="" && get_option( 'xyz_smap_current_twappln_token' )!="" && get_option( 'xyz_smap_twaccestok_secret' )!="" && get_option( 'xyz_smap_twpost_permission' )==1 ) )
		add_meta_box( "xyz_smap", '<strong>Auto Share</strong>', 'xyz_smap_addpostmetatags' ) ;
...
function xyz_smap_addpostmetatags() {
	$imgpath= VMENU_URL . "/includes/social-media-auto-publish/admin/images/";
	...
	<div class="premise-row">
		<?php
			premise_field(
				...
				array(
					'wrapper_class' => 'span6',
					'label' => 'Enable Auto Share posts to my Facebook account',
			...
			premise_field(
				'select',
				array(
					'wrapper_class' => 'span6 facebook-fields',
					'label' => 'Posting Method',
					'name' => 'xyz_smap_po_method',
					'options' => array(
						'Simple text message' => '3',
						'Text message with image: Upload image to app album' => '4',
						'Text message with image: Upload image to timeline album' => '5',
						'Text message with attached link: Attach your blog post' => '1',
						'Text message with attached link: Share a link to your blog post' => '2',
					),
				)
			); ?>
		<div class="span4 facebook-fields">
			Message Format for Posting:
			<?php echo premise_tooltip( '{POST_TITLE} - Insert the title of your post. {PERMALINK} -
		...
		<div class="span8 facebook-fields">
		<?php premise_field(
				'select',
				array(
...
<tr>
		<td colspan="2" class="xyz_smap_pleft15 xyz_smap_meta_acclist_table_td">
			<i class="fa fa-twitter"></i> <strong>Facebook</strong>
		</td>
</tr>
	...
	<div class="premise-row">
		<?php
			premise_field(
				...
				array(
					'wrapper_class' => 'span6',
					'label' => 'Enable Auto Share posts to my Twitter account',
			...
			premise_field(
				'select',
				array(
					'wrapper_class' => 'span6 twitter-fields',
					'label' => 'Attach image to Twitter post',
		...
		<div class="span4 twitter-fields">
			Message Format for Posting:
			<?php echo premise_tooltip( '{POST_TITLE} - Insert the title of your post. {PERMALINK} -
				Insert the URL where your post is displayed. {POST_EXCERPT}
				- Insert the excerpt of your post. {POST_CONTENT} - Insert
		...
		<div class="span8 twitter-fields">
		<?php premise_field(
				'select',
				array(
