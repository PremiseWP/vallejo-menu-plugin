...
// $lnredirecturl=admin_url('admin.php?page=vmenu_settings&auth=3');
...
// 		}while(array_key_exists("next", $pagearray1->paging));
		...
		if($xyz_smap_af==1){
			header("Location:".admin_url('admin.php?page=vmenu_settings&msg=3'));
			exit();
		}
	}
}
	...
	//header("Location:".admin_url('admin.php?page=vmenu_settings&msg=2'));
	//exit();
}

/*$state=md5(get_home_url());

$redirecturl=urlencode(admin_url('admin.php?page=vmenu_settings'));
	...
	{
		header("Location:".admin_url('admin.php?page=vmenu_settings&msg=1'));
		exit();
	}
	else if(isset($_GET['code']) && isset($_GET['state']) && $_GET['state']==$state)
	{
		...
		header("Location:".admin_url('admin.php?page=vmenu_settings&msg=4'));
		exit();
	}*/
