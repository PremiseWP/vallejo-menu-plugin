...
function xyz_smap_add_admin_scripts()
{
	...
	wp_register_script( 'xyz_notice_script', plugins_url('vallejo-menu-plugin/includes/social-media-auto-publish/js/notice.js') );
	wp_enqueue_script( 'xyz_notice_script' );
	
	wp_register_style('xyz_smap_style', plugins_url('vallejo-menu-plugin/includes/social-media-auto-publish/admin/style.css'));
